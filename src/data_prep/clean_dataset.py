...
if __name__ == "__main__":
    ...
    parser.add_argument("--thresh_mean", type=float, default=15.0, help="Darkness threshold")
    parser.add_argument("--thresh_std", type=float, default=15.0, help="Flatness/std threshold")
