...
def main():
    ...
    if level_obj == "red" or level_dist == "red":
        ...
        input("[INFO] Press Enter to continue anyway or Ctrl+C to cancel...")
    elif level_obj == "orange" or level_dist == "orange":
        print("\n[WARNING] High density detected! Consider increasing MAX_RADIUS or decreasing BUDGET.")
        print("[INFO] Continuing in 10 seconds... (Press Ctrl+C to cancel)")
        time.sleep(10)
